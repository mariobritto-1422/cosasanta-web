...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = `Eres un experto en marketing digital latinoamericano. Genera 3 publicaciones para redes sociales (Instagram/Facebook/LinkedIn) para la siguiente empresa:
